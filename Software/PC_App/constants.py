...
DEFAULT_CAM_PORT = 'Software\PC_App\Testing\screens_vbox_cam\T08_vbox_cam.png'               # Default USB port for camera
...
FOBJ_MATCH_THRESHOLD = 73             # Acceptance threshold for matching template # Used to be 50, TODO: Ask @christian 
